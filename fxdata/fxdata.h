...
constexpr uint24_t FX_DATA_BYTES = 44957;
...
constexpr uint24_t FX_STR_TOTUNE = 0x0000B3;
constexpr uint24_t FX_DATA_1 = 0x0000BB;
constexpr uint24_t FX_DATA_2 = 0x000116;
constexpr uint24_t FX_DATA_3 = 0x000193;
constexpr uint24_t FX_LEVEL1 = 0x000217;
constexpr uint24_t FX_LEVEL2 = 0x00027B;
constexpr uint24_t FX_LEVEL3 = 0x0002DF;
constexpr uint24_t FX_LEVEL4 = 0x000343;
constexpr uint24_t FX_LEVEL5 = 0x0003A7;
constexpr uint24_t FX_LEVEL6 = 0x00040B;
constexpr uint24_t FX_LEVEL7 = 0x00046F;
constexpr uint24_t FX_LEVEL8 = 0x0004D3;
constexpr uint24_t FX_LEVEL9 = 0x000537;
constexpr uint24_t FX_LEVEL10 = 0x00059B;
constexpr uint24_t FX_LEVEL_TIMES = 0x0005FF;
constexpr uint24_t FX_DATA_FONT46 = 0x00063B;
...
constexpr uint24_t FX_DATA_TILES_56 = 0x0043D7;
...
constexpr uint24_t FX_DATA_TILES_48 = 0x00689B;
...
constexpr uint24_t FX_DATA_TILES_40 = 0x00839F;
...
constexpr uint24_t FX_DATA_TILES_32 = 0x009663;
...
constexpr uint24_t FX_DATA_TILES_24 = 0x00A267;
...
constexpr uint24_t FX_DATA_TILES_16 = 0x00A92B;
...
constexpr uint24_t FX_DATA_TILES_8 = 0x00AC2F;
...
constexpr uint24_t FX_DATA_TILES_6 = 0x00ACF3;
...
constexpr uint24_t FX_DATA_TILES_3 = 0x00AD87;
...
constexpr uint24_t FX_DATA_ABOUT = 0x00ADD3;
constexpr uint16_t FX_DATA_ABOUT_WIDTH  = 48;
constexpr uint16_t FX_DATA_ABOUTHEIGHT  = 48;

constexpr uint24_t FX_SOUND_INTRO = 0x00AEF7;
